# XGB1 Binary Classifier in PiML with Shapley explanations
## Project Description
...
- A **XGB1 classifier** algorithm built using **PiML**
...
- **`src/`**: This directory holds the source code for the project. It is further divided into various subdirectories:
  ...
  - **`prediction/`**: Scripts for the XGB1 classifier model implemented using **Scikit-Learn** library.
